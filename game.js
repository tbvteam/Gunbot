...
itemImages.heal.src = "heal.png";
itemImages.armor.src = "armor.png";
itemImages.assist.src = "assist.png";

const assistantImg = new Image();
assistantImg.src = "assistant.png";
const playerBulletImg = new Image();
playerBulletImg.src = "bullet-player.png";
const assistantBulletImg = new Image();
assistantBulletImg.src = "bullet-assistant.png";
let startTime;
let player = {
  hp: 200,
  baseHp: 200,
...
function resetGame() {
  // Đặt lại toàn bộ trạng thái game
  player = {
    hp: 200,
    baseHp: 200,
    damage: 50,
  ...
  level = 0; // Quan trọng: để nextLevel() set lại level = 1
  enemies = [];
  bullets = [];
  items = [];
  boss = null;
